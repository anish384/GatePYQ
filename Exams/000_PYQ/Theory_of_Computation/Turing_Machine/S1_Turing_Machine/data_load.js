window.__examLoadCallback({
  "title": "Theory_of_Computation - Turing_Machine — Slot 1 (14 Questions)",
  "duration": 39,
  "sections": [
    {
      "name": "Turing_Machine — Slot 1",
      "questions": [
        {
          "id": 1,
          "question": "<p>Consider a finite state machine (FSM) with one input \\( X \\) and one output \\( f \\), represented by the given state transition table. The minimum number of states required to realize this FSM is _________. (Answer in integer)\n<br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\Turing_Machine\\q49_cb7ac266.webp\"><br> <br><br><strong>(GATE CSE 2025 SET-1)</strong></p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "5",
          "marks": 2,
        ...
        {
          "id": 13,
          "question": "<p>A single tape Turing Machine M has two states q0 and q1, of which q0 is the starting state. The tape alphabet of M is {0, 1, B} and its input alphabet is {0, 1}. The symbol B is the blank symbol used to indicate end of an input string. The transition function of M is described in the following table   <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\Turing_Machine\\q53_abd93de7.jpg\"><br> The table is interpreted as illustrated below. The entry (q1, 1, R) in row q0 and column 1 signifies that if M is in state q0 and reads 1 on the current tape square, then it writes 1 on the same tape square, moves its tape head one position to the right and transitions to state q1. Which of the following statements is true about M ? <br><br><strong>(GATE CSE 2003)</strong></p>",
          "type": "single",
          "options": [
