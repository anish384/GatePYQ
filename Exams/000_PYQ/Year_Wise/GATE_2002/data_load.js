  ...
  "sections": [
    {
      ...
      "questions": [
        {
          "id": 1,
          "question": "<p>The rank of the matrix \\(\\begin{bmatrix} 1 &amp; 1\\\\ 0&amp; 0 \\end{bmatrix}\\) is</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>4</p>",
            "<b>B.</b> <p>2</p>",
        ...
        {
          "id": 2,
          "question": "<p>The trapezoidal rule for integration gives exact result when the integrand is a polynomial of degree</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>0 but not 1</p>",
            "<b>B.</b> <p>1 but not 0</p>",
            "<b>C.</b> <p>0 or 1</p>",
            "<b>D.</b> <p>2</p>"
          ],
          "correct_answer": "<b>C.</b> <p>0 or 1</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/806/gate2002-1-2#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 3,
          "question": "<p>The solution to the recurrence equation \\(T(2^{k})=3T(2^{k-1})+1,T(1)=1\\) is</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>\\(2^{k}\\)</p>",
        ...
        {
          "id": 10,
          "question": "<p>In 8085 which of the following modifies the program counter ?</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 12,
          "question": "<p>Minimum sum of product expression for f (w,x,y,z) shown in Karnaugh-map\nbelow is <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\GATE_2002\\q12_63e58d40.jpg\"></p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>xz + y'z</p>",
            "<b>B.</b> <p>xz'+zx'</p>",
          ...
          "correct_answer": "<b>B.</b> <p>xz'+zx'</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/816/gate2002-1-12#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 13,
          "question": "<p>Which of the following is not a form of memory ?</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 14,
          "question": "<p>The decimal value of 0.25</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 15,
          "question": "<p>The 2's complement represent representation of the decimal value -15 is</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>1111</p>",
            "<b>B.</b> <p>11111</p>",
        ...
        {
          "id": 16,
          "question": "<p>Sign extension is a step in</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 17,
          "question": "<p>In the C language</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 21,
          "question": "<p>In 2's complement addition, overflow</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 22,
          "question": "<p>Which of the following scheduling algorithms is non-preemptive ?</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 23,
          "question": "<p>The optimal page replacement algorithm will select the page that</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 24,
          "question": "<p>In the absolute the Addressing Modes :</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 25,
          "question": "<p>Maximum number of edges in a n-node undirected graph without self loops is</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>\\({n}^{2}\\)</p>",
        ...
        {
          "id": 26,
          "question": "<p>Consider the following logic circuit whose inputs are functions f1, f2, f3 and output\nis f <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\GATE_2002\\q26_d435cff8.jpg\"> <br> Given that\n<br><br>\nf1(x, y, z) = \\(\\Sigma\\)(0, 1, 3, 5), <br>\nf2(x, y, z) = \\(\\Sigma\\)(6, 7) and <br>\nf(x, y, z) = \\(\\Sigma\\)(1, 4, 5),<br>\n<br><br>\nf3 is :</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>\\(\\Sigma\\) (1,4,5)</p>",
            "<b>B.</b> <p>\\(\\Sigma\\) (6,7)</p>",
            "<b>C.</b> <p>\\(\\Sigma\\) (0,1,3,5)</p>",
            "<b>D.</b> <p>None of the above</p>"
          ],
          "correct_answer": "<b>A.</b> <p>\\(\\Sigma\\) (1,4,5)</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/831/gate2002-2-1#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 27,
          "question": "<p>Consider the following multiplexor where I0,I1,I2,I3 are four data input lines\nselected by two address line combinations A1A0 = 00,01,10,11 respectively and\nf is the output of the multiplexor. EN is the Enable input. <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\GATE_2002\\q27_4b0295b7.jpg\"> <br>The function f (x,y,z) implemented by the above circuit is</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>xyz'</p>",
            "<b>B.</b> <p>xy + z</p>",
        ...
        {
          "id": 28,
          "question": "<p>Let f(A,B) = A' + B. Simplified expression for function f(f(x+y,y),z) is</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>x' + z</p>",
            "<b>B.</b> <p>xyz</p>",
          ...
          "correct_answer": "<b>C.</b> <p>xy' + z</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/833/gate2002-2-3#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 29,
        ...
        {
          "id": 31,
          "question": "<p>The performance of a pipelined processor suffers if</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 32,
          "question": "<p>Horizontal microprogramming</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 34,
          "question": "<p>The number of leaf nodes in a rooted tree of n nodes, with each node having 0\nor 3 children is</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>n/2</p>",
            "<b>B.</b> <p>\\(\\frac{(n-1)}{3}\\)</p>",
            "<b>C.</b> <p>\\(\\frac{(n-1)}{2}\\)</p>",
            "<b>D.</b> <p>\\(\\frac{(2n+1)}{3}\\)</p>"
          ],
          "correct_answer": "<b>D.</b> <p>\\(\\frac{(2n+1)}{3}\\)</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/839/gate2002-2-9#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 35,
          "question": "<p>Consider the following algorithm for searching for a given number x in an unsorted\narray A[1.....n] having n distinct values : <br><br>\n(1) Choose an i uniformly at random from [1....n]<br>\n(2) If A[i] = x then stop else Goto 1; <br><br>\nAssuming that x is present A, What is the expected number of comparisons made\nby the algorithm before it terminates?</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>n</p>",
            "<b>B.</b> <p>n-1</p>",
        ...
        {
          "id": 36,
          "question": "<p>The running time of the following algorithm <br><br>\nProcedure A(n)<br>\nIf n \\(\\leq\\) 2 return (1) else return (A(\\(\\sqrt{n}\\))); <br><br> is best discribed by</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>O(n)</p>",
            "<b>B.</b> <p>O(log n)</p>",
        ...
        {
          "id": 40,
          "question": "<p>The Newton-Raphson iteration \\(X_{n+1}=(X_{n}/2)+(3/(2X_{n}))\\)\ncan be used to solve the equation</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>\\(X^{2}=3\\)</p>",
            "<b>B.</b> <p>\\(X^{3}=3\\)</p>",
          ...
          "correct_answer": "<b>A.</b> <p>\\(X^{2}=3\\)</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/845/gate2002-2-15#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 41,
          "question": "<p>Four fair coins are tossed simultaneously. The probability that at least one head and one tail turn up is</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>\\(1/16\\)</p>",
            "<b>B.</b> <p>\\(1/8\\)</p>",
        ...
        {
          "id": 42,
          "question": "<p>The binary relation?S = \\(\\phi\\) (empty set) on set A = {1,2,3} is</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 43,
          "question": "<p>The C language is :</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 44,
          "question": "<p>To evaluate an expression without any embedded function calls</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 45,
          "question": "<p>Dynamic linking can cause security concerns because</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 50,
          "question": "<p>From the following instance of relation schema R(A,B,C), we can conclude that : <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\GATE_2002\\q50_e0841df0.jpg\"></p>",
          "type": "single",
          "options": [
