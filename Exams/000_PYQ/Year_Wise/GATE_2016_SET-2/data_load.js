window.__examLoadCallback({
  "title": "Year_Wise - GATE_2016_SET-2",
  "duration": 180,
  "sections": [
    {
      "name": "GATE_2016_SET-2",
      "questions": [
        {
          "id": 1,
          "question": "<p>Consider the following expressions:<br>\n(i) false <br>\n(ii) Q <br>\n(iii) true <br>\n(iv) \\(P\\vee Q\\) <br>\n(v) \\(\\neg Q \\vee P\\) <br>\nThe number of expressions given above that are logically implied by \\(P \\wedge (P \\Rightarrow Q)\\) is ________.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "4",
          "marks": 1,
        ...
        {
          "id": 2,
          "question": "<p>Let f(x) be a polynomial and g(x) = f'(x) be its derivative. If the degree of (f(x)+ f(-x)) is 10, then the degree of (g(x)-g(-x)) is ________.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "9",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<a href=\"https://gateoverflow.in/39571/gate2016-2-2#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 3,
          "question": "<p>The minimum number of colours that is sufficient to vertex-colour any planar graph is _________.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "4",
          "marks": 1,
        ...
        {
          "id": 4,
          "question": "<p>Consider the systems,each consisting of m linear equations in n variables.<br>\nI. If m \\(\\lt\\) n, then all such systems have a solution <br>\nII. If m \\(\\gt\\) n, then none of these systems has a solution <br>\nIII. If m = n, then there exists a system which has a solution <br>\nWhich one of the following is CORRECT?</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>I, II and III are true</p>",
            "<b>B.</b> <p>Only II and III are true</p>",
            "<b>C.</b> <p>Only III is true</p>",
            "<b>D.</b> <p>None of them is true</p>"
          ],
          "correct_answer": "<b>C.</b> <p>Only III is true</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/39554/gate2016-2-4#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 5,
          "question": "<p>Suppose that a shop has an equal number of LED bulbs of two different types. The probability of an LED bulb lasting more than 100 hours given that it is of Type 1 is 0.7, and given that it is of Type 2 is 0.4. The probability that an LED bulb chosen uniformly at random lasts more than 100 hours is _________.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "0.55",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<a href=\"https://gateoverflow.in/39541/gate2016-2-5#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 6,
          "question": "<p>Suppose that the eigen values of matrix A are 1, 2, 4. The determinant of \\((A^{-1})^{T}\\) is _________.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "0.124",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<a href=\"https://gateoverflow.in/39549/gate2016-2-6#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 7,
          "question": "<p>Consider an eight-bit ripple-carry Combinational Circuit for computing the sum of A and B, where A and B are integers represented in 2's complement form. If the decimal value of  A is one, the decimal value of B that leads to the longest latency for the sum to stabilize is ________.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "-1",
          "marks": 1,
        ...
        {
          "id": 8,
          "question": "<p>Let, \\(x_{1} \\oplus x_{2} \\oplus\nx_{3} \\oplus x_{4}=0\\) where \\(x_{1},  x_{2} ,\nx_{3} , x_{4}\\)  are Boolean variables, and  \\(\\oplus\\) is the XOR operator.\nWhich one of the following must always be TRUE?</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>\\(x_{1} x_{2} x_{3} x_{4}=0\\)</p>",
            "<b>B.</b> <p>\\(x_{1} x_{3}+ x_{2}=0\\)</p>",
            "<b>C.</b> <p>\\(\\bar{x}_{1}\\oplus \\bar{x}_{3}=\\bar{x}_{2}\\oplus \\bar{x}_{4}\\)</p>",
            "<b>D.</b> <p>\\(x_{1} +x_{2}+ x_{3}+ x_{4}=0\\)</p>"
          ],
          "correct_answer": "<b>C.</b> <p>\\(\\bar{x}_{1}\\oplus \\bar{x}_{3}=\\bar{x}_{2}\\oplus \\bar{x}_{4}\\)</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/39540/gate2016-2-8#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 9,
          "question": "<p>Let X be the number of distinct 16-bit integers in 2's complement representation. Let Y be the number of distinct 16 bit integers in sign magnitude representation. Then X-Y is ________.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "1",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<a href=\"https://gateoverflow.in/39546/gate2016-2-9#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 10,
          "question": "<p>A processor has 40 distinct instructions and 24 general purpose registers. A 32-bit instruction word has an opcode, two register operands and an immediate operand. The number of bits available for the immediate operand field is _______ .</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "16",
          "marks": 1,
        ...
        {
          "id": 11,
          "question": "<p>Breadth First Search(BFS) is started on a binary tree beginning from the root vertex. There is a vertex t at a distance four from the root. If t is the n-th vertex in this BFS traversal, then the maximum possible value of n is______ .</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "31",
          "marks": 1,
        ...
        {
          "id": 14,
          "question": "<p>The Floyd-Warshall algorithm for all-pair shortest paths computation is based on</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 16,
          "question": "<p>The number of states in the minimum sized DFA that accepts the language defined by the regular expression <br>(0+1)* (0+1)(0+1)* <br> is _______.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "2",
          "marks": 1,
        ...
        {
          "id": 19,
          "question": "<p>Match thefollowing:\n<br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\GATE_2016_SET-2\\q19_26e5b72c.jpg\"></p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 20,
          "question": "<p>In which one of the following page replacement algorithms it is possible for the page fault rate to increase even when the number of allocated frames increases?</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 21,
          "question": "<p>B+ Trees are considered BALANCED because</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>the lengths of the paths from the root to all leaf nodes are all equal.</p>",
            "<b>B.</b> <p>the lengths of the paths from the root to all leaf nodes differ from each other by at most 1.</p>",
            "<b>C.</b> <p>the number of children of any two non-leaf sibling nodes differ by at most 1</p>",
            "<b>D.</b> <p>the number of records in any two leaf nodes differ by at most 1.</p>"
          ],
          "correct_answer": "<b>A.</b> <p>the lengths of the paths from the root to all leaf nodes are all equal.</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/39569/gate2016-2-21#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 22,
        ...
        {
          "id": 23,
          "question": "<p>Anarkali digitally signs a message and sends it to Salim. Verification of the signature by Salim requires</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 24,
          "question": "<p>In an Ethernet local area network,which one of the following statements is TRUE?</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 25,
          "question": "<p>Identify the correct sequence in which the following packets are transmitted on the network by a host when a browser requests a webpage from a remote server,assuming that the host has just been restarted.</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 26,
          "question": "<p>A binary relation R on \\(\\mathbb{N}\\times \\mathbb{N}\\)  is defined as follows: (a,b)R(c,d) if   \\(a \\leq c\\)\nor \\(b \\leq d\\). Consider the following propositions:<br>\nP: R is reflexive <br>\nQ: R is transitive <br>\nWhich one of the following statements is TRUE?</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>Both P and Q are true</p>",
            "<b>B.</b> <p>P is true and Q is false.</p>",
          ...
          "marks": 2,
          "negative_marks": 0.67,
          "explanation": "<a href=\"https://gateoverflow.in/39603/gate2016-2-26#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 27,
          "question": "<p>Which one of the following well-formed formulae in predicate calculus is NOT valid?</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>\\((\\forall x p(x)\\Rightarrow \\forall xq(x))\\Rightarrow (\\exists x\\neg p(x) \\vee \\forall xq(x))\\)</p>",
            "<b>B.</b> <p>\\((\\exists xp(x)\\vee \\exists xq(x))\\Rightarrow \\exists x(p(x)\\vee  q(x))\\)</p>",
            "<b>C.</b> <p>\\(\\exists x (p(x)\\wedge q(x)) \\Rightarrow (\\exists xp(x)\\wedge \\exists xq(x))\\)</p>",
            "<b>D.</b> <p>\\(\\forall x (p(x)\\vee q(x))\\Rightarrow (\\forall x p(x) \\vee \\forall x q(x)) \\)</p>"
          ],
          "correct_answer": "<b>D.</b> <p>\\(\\forall x (p(x)\\vee q(x))\\Rightarrow (\\forall x p(x) \\vee \\forall x q(x)) \\)</p>",
          "marks": 2,
          "negative_marks": 0.67,
          "explanation": "<a href=\"https://gateoverflow.in/39618/gate2016-2-27#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 28,
          "question": "<p>Consider a set U of 23 different compounds in a Chemistry lab. There is a subset S of U of 9 compounds, each of which reacts with exactly 3 compounds of  U. Consider the following statements: <br><br>\nI. Each compound in U \\ S reacts with an odd number of compounds. <br>\nII. At least one compound in U \\ S reacts with an odd number of compounds. <br>\nIII. Each compound in U n S reacts with an even number of compounds. <br><br>\nWhich one of the above statements is ALWAYS TRUE?</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>Only I</p>",
            "<b>B.</b> <p>Only II</p>",
          ...
          "correct_answer": "<b>B.</b> <p>Only II</p>",
          "marks": 2,
          "negative_marks": 0.67,
          "explanation": "<a href=\"https://gateoverflow.in/39595/gate2016-2-28#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 29,
          "question": "<p>The value of the expression \\(13^{99}\\)(mod 17), in the range 0 to 16, is _________.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "4",
          "marks": 2,
          "negative_marks": 0,
          "explanation": "<a href=\"https://gateoverflow.in/39588/gate2016-2-29#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 30,
          "question": "<p>Suppose the functions F and G can be computed in 5 and 3 nano seconds by functional units \\(U_{F}\\) and \\(U_{G}\\), respectively. Given two instances of \\(U_{F}\\) and two instances of \\(U_{G}\\), it is required to implement the computation \\(F(G(X_{i}))\\) for \\(1\\leq i\\leq 10\\). Ignoring all other delays, the minimum time required to complete this computation is ________ nanoseconds.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "28",
          "marks": 2,
        ...
        {
          "id": 32,
          "question": "<p>The width of the physical address on a machine is 40 bits. The width of the tag field in a 512KB 8-way set associative cache is ________ bits.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "24",
          "marks": 2,
        ...
        {
          "id": 33,
          "question": "<p>Consider a 3GHz (gigahertz) processor with a three-stage pipeline and stage latencies \\(\\tau _{1}\\), \\(\\tau _{2}\\), and \\(\\tau _{3}\\) such that \\(\\tau _{1}=3\\tau _{2}/4=2\\tau _{3}\\). If the longest pipeline stage is split into two pipeline stages of equal latency, the new frequency is _____GHz, ignoring delays in the pipeline registers.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "3.9",
          "marks": 2,
        ...
        {
          "id": 38,
          "question": "<p>Let A1,A2,A3, and A4 be four matrices of dimensions 10x5, 5x20, 20x10, and 10x5, respectively. The minimum number of scalar multiplications required to find the product A1A2A3A4 using the basic matrix multiplication method is __________.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "1500",
          "marks": 2,
        ...
        {
          "id": 40,
          "question": "<p>The number of ways in which the numbers 1,2,3,4,5,6,7 can be inserted in an empty binary search tree, such that the resulting tree has height 6, is _____.<br>\nNote: The height of a tree with a single node is 0.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "64",
          "marks": 2,
          "negative_marks": 0,
          "explanation": "<a href=\"https://gateoverflow.in/39586/gate2016-2-40#a_list\" targer=\"_blank\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 41,
          "question": "<p>In an adjacency list representation of an undirected simple graph G = (V,E), each edge (u,v) has two adjacency list entries: [v] in the adjacency list of u, and [u] in the adjacency list of v. These are called twins of each other. A twin pointer is a pointer from an adjacency list entry to its twin. If |E|=m and |V|=n, and the memory size is not a constraint, what is the Asymptotic Notation of the most efficient algorithm to set the twin pointer in each entry in each adjacency list?</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>\\(\\Theta (n^{2})\\)</p>",
            "<b>B.</b> <p>\\(\\Theta (n+m)\\)</p>",
        ...
        {
          "id": 43,
          "question": "<p>Consider the following languages: <br>\\(L_{1}=\\{a^{n}b^{m}c^{n+m}:m,n\\geq 1\\}\\)<br> \\(L_{2}=\\{a^{n}b^{n}c^{2n}:n\\geq 1\\}\\) <br>Which one of the following is TRUE?</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 45,
          "question": "<p>Which one of the following grammars is free from left recursion?</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 46,
          "question": "<p>A student wrote two context-free grammars G1 and G2 for generating a single C-like array declaration. The dimension of the array is at least one. For example, <br>\nint a[10][3]; <br>\nThe grammars use D as the start symbol,and use six terminal symbols <b>int ;id[]num.</b> <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\GATE_2016_SET-2\\q46_7b18643f.jpg\"> <br>\nWhich of the grammars correctly generate the declaration mentioned above?</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 47,
          "question": "<p>Consider the following processes, with the arrival time and the length of the CPU burst given in milli seconds.The scheduling algorithm used is preemptive shortest remaining-time first.<br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\GATE_2016_SET-2\\q47_5095f5ac.jpg\"><br> The average turn around time of these processes is milliseconds.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "8.2",
          "marks": 2,
        ...
        {
          "id": 48,
          "question": "<p>Consider the following two-process synchronization solution. <br>\n<br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\GATE_2016_SET-2\\q48_7f562996.jpg\"><br>\nThe shared variable turn is initialized to zero.Which one of the following is TRUE?</p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 49,
          "question": "<p>Consider a non-negative counting semaphore S. The operation P(S) decrements S, and V(S) increments S. During an execution, 20 P(S) operations and 12V(S) operations are issued in some order. The largest initial value of S for which at least one P(S) operation will remain blocked is ________.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "7",
          "marks": 2,
        ...
        {
          "id": 52,
          "question": "<p>Consider the following database table named water_schemes : <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\GATE_2016_SET-2\\q52_3b8c0d21.jpg\"><br> The number of tuples returned by the following SQL query is __________.\n<br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\GATE_2016_SET-2\\q52a_85159664.jpg\"></p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "2",
          "marks": 2,
        ...
        {
          "id": 53,
          "question": "<p>A network has a data transmission bandwidth of \\(20 \\times 10^{6}\\) bits per second. It uses CSMA/CD in the MAClayer. The maximum signal propagation time from one node to another node is 40 microseconds. The minimum size of a frame in the network is  ______ bytes.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "200",
          "marks": 2,
        ...
        {
          "id": 55,
          "question": "<p>Consider a \\(128 \\times 10^{3}\\) bits/second satellite communication link with one way propagation delay of 150 milliseconds. Selective retransmission(repeat) protocol is used on this link to send data with a frame size of 1 kilobyte. Neglect the transmission time of acknowledgement. The minimum number of bits required for the sequence number field to achieve 100% utilization is ________.</p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "4",
          "marks": 2,
        ...
        {
          "id": 56,
          "question": "<p>The man who is now Municipal Commissioner worked as _____________</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>the security guard at a university</p>",
            "<b>B.</b> <p>a security guard at the university</p>",
            "<b>C.</b> <p>a security guard at university</p>",
            "<b>D.</b> <p>the security guard at the university</p>"
          ],
          "correct_answer": "<b>B.</b> <p>a security guard at the university</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/39529/gate-cse-2016-set-2-question-ga-01#a_list\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 57,
          "question": "<p>Nobody knows how the Indian cricket team is going to cope with the difficult and seamer-friendly wickets in Australia.\n<br><br>\nChoose the option which is closest in meaning to the underlined phrase in the above sentence.</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>Put up with.</p>",
            "<b>B.</b> <p>Put in with.</p>",
            "<b>C.</b> <p>Put down to.</p>",
            "<b>D.</b> <p>Put up against.</p>"
          ],
          "correct_answer": "<b>A.</b> <p>Put up with.</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/39531/gate-cse-2016-set-2-question-ga-02#a_list\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 58,
          "question": "<p>Find the odd one in the following group of words.\n<br><br>\nmock, deride, praise, jeer</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>Mock</p>",
            "<b>B.</b> <p>Deride</p>",
          ...
          "correct_answer": "<b>C.</b> <p>Praise</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/39530/gate-cse-2016-set-2-question-ga-03#a_list\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 59,
          "question": "<p>Pick the odd one from the following options.</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>CADBE</p>",
            "<b>B.</b> <p>JHKIL</p>",
          ...
          "correct_answer": "<b>D.</b> <p>ONPMQ</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/39528/gate-cse-2016-set-2-question-ga-04#a_list\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 60,
          "question": "<p>In a quadratic function, the value of the product of the roots \\((\\\\alpha ,\\\\beta )\\) is 4. Find the value of <br><br>\\(\\\\frac{\\\\alpha^{n}+\\\\beta^{n}}{\\\\alpha^{-n}+\\\\beta^{-n}}\\)</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>\\(n^4\\)</p>",
            "<b>B.</b> <p>\\(4^n\\)</p>",
          ...
          "correct_answer": "<b>B.</b> <p>\\(4^n\\)</p>",
          "marks": 1,
          "negative_marks": 0.33,
          "explanation": "<a href=\"https://gateoverflow.in/39532/gate-cse-2016-set-2-question-ga-05#a_list\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 61,
          "question": "<p>Among 150 faculty members in an institute, 55 are connected with each other through Facebook and 85 are connected through Whatsapp. 30 faculty members do not have Facebook or Whatsapp accounts. The numbers of faculty members connected only through Facebook accounts is _______.</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>35</p>",
            "<b>B.</b> <p>45</p>",
          ...
          "marks": 2,
          "negative_marks": 0.67,
          "explanation": "<a href=\"https://gateoverflow.in/39536/gate-cse-2016-set-2-question-ga-06#a_list\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 62,
          "question": "<p>Computers were invented for performing only high-end useful computations. However, it is no understatement that they have taken over our world today. The internet, for example, is ubiquitous. Many believe that the internet itself is an unintended consequence of the original invention. With the advent of mobile computing on our phones, a whole new dimension is now enabled. One is left wondering if all these developments are good or, more importantly, required.<br><br>Which of the statement(s) below is/are logically valid and can be inferred from the above paragraph?<br>(i) The author believes that computers are not good for us.\n<br>\n(ii) Mobile computers and the internet are both intended inventions.</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>(i) only</p>",
            "<b>B.</b> <p>(ii) only</p>",
          ...
          "marks": 2,
          "negative_marks": 0.67,
          "explanation": "<a href=\"https://gateoverflow.in/39533/gate-cse-2016-set-2-question-ga-07#a_list\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 63,
          "question": "<p>All hill-stations have a lake. Ooty has two lakes.<br>\n<br>\nWhich of the statement(s) below is/are logically valid and can be inferred from the above sentences?\n<br><br>\n(i).   Ooty is not a hill-station.\n<br>(ii).  No hill-station can have more than one lake.</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>(i) only.</p>",
            "<b>B.</b> <p>(ii) only.</p>",
          ...
          "marks": 2,
          "negative_marks": 0.67,
          "explanation": "<a href=\"https://gateoverflow.in/39534/gate-cse-2016-set-2-question-ga-08#a_list\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 64,
          "question": "<p>In a 2x4 rectangle grid shown below, each cell is rectangle. How many rectangles can be observed in the grid?<br><br>\\(\\begin{array}{|c|c|c|c|c|}\\hline{\\;\\;\\;}&amp;{\\;\\;\\;}&amp;{\\;\\;\\;}&amp;{\\;\\;\\;}\\\\\\hline{}&amp;{}&amp;{}&amp;\\\\\\hline\\end{array}\\)</p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>21</p>",
            "<b>B.</b> <p>27</p>",
          ...
          "marks": 2,
          "negative_marks": 0.67,
          "explanation": "<a href=\"https://gateoverflow.in/39537/gate-cse-2016-set-2-question-ga-09#a_list\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        },
        {
          "id": 65,
          "question": "<p><br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\GATE_2016_SET-2\\q65_14c1eb7c.jpg\"><br></p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>\\(f(x) = 1 - |x - 1|\\)</p>",
            "<b>B.</b> <p>\\(f(x) = 1 + |x - 1|\\)</p>",
          ...
          "correct_answer": "<b>C.</b> <p>\\(f(x) = 2 - |x - 1|\\)</p>",
          "marks": 2,
          "negative_marks": 0.67,
          "explanation": "<a href=\"https://gateoverflow.in/39535/gate-cse-2016-set-2-question-ga-10#a_list\" target=\"_blank\" rel=\"noopener\">Click here for detail solution by gateoverflow</a>"
        }
      ]
    }
  ]
