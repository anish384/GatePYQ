window.__examLoadCallback({
  "title": "Operating_System - Process_Synchronization — Slot 2 (15 Questions)",
  "duration": 42,
  "sections": [
    {
      "name": "Process_Synchronization — Slot 2",
      "questions": [
        {
          "id": 1,
        ...
        {
          "id": 7,
          "question": "<p>Two processes X and Y need to access a critical section. Consider the following synchronization construct used by both the processes <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\Process_Synchronization\\q21_3ddcb876.jpg\"> <br> Here, varP and varQ are shared variables and both are initialized to false. Which one of the following statements is true? <br><br><strong>(GATE CSE 2015 SET-3)</strong></p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 8,
          "question": "<p>The following two functions P1 and P2 that share a variable B with an initial value of 2 execute concurrently. <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\Process_Synchronization\\q20_e8cf7316.jpg\"> <br> The number of distinct values that B can possibly take after the execution is______________. <br><br><strong>(GATE CSE 2015 SET-1)</strong></p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "3",
          "marks": 1,
