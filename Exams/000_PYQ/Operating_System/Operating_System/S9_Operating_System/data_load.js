window.__examLoadCallback({
  "title": "Operating_System - Operating_System — Slot 9 (15 Questions)",
  "duration": 42,
  "sections": [
    {
      "name": "Operating_System — Slot 9",
      "questions": [
        {
          "id": 1,
        ...
        {
          "id": 3,
          "question": "<p>The maximum number of processes that can be in Ready state for a computer system with n CPUs is <br><br><strong>(GATE CSE 2015 SET-3)</strong></p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>n</p>",
            "<b>B.</b> <p>\\(n^{2}\\)</p>",
        ...
        {
          "id": 12,
          "question": "<p>The following two functions P1 and P2 that share a variable B with an initial value of 2 execute concurrently. <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\Operating_System\\q20_e8cf7316.jpg\"> <br> The number of distinct values that B can possibly take after the execution is______________. <br><br><strong>(GATE CSE 2015 SET-1)</strong></p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "3",
          "marks": 1,
