window.__examLoadCallback({
  "title": "C_Programming - Arithmetic_Operation — Slot 1 (15 Questions)",
  "duration": 42,
  "sections": [
    {
      "name": "Arithmetic_Operation — Slot 1",
      "questions": [
        {
          "id": 1,
        ...
        {
          "id": 2,
          "question": "<p>What is printed by the following ANSI C program?<pre><code>#include &lt; stdio.h &gt;\nint main(int argc, char *argv[]){ \n char a = 'P';\n char b = 'x';\n char c = (a  &amp;  b) + '*';\n char d = (a | b) - '-';\n char e = (a ^ b) + '+'; \n printf(\"%c %c %c \\n\", c, d, e); \n return 0;\n}\n</code></pre><br>ASCII encoding for relevant characters is given below<br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\Arithmetic_Operation\\q34_c5d530be.jpg\"><br> <br><br><strong>(GATE CSE 2022)</strong></p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>z K  S</p>",
            "<b>B.</b> <p>122 75  83</p>",
