window.__examLoadCallback({
  "title": "Algorithms - Minimum_Spanning_Tree — Slot 3 (11 Questions)",
  "duration": 30,
  "sections": [
    {
      "name": "Minimum_Spanning_Tree — Slot 3",
      "questions": [
        {
          "id": 1,
          "question": "<p>Consider the following graph: <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\Minimum_Spanning_Tree\\q47_564dc013.jpg\"><br> Which one of the following cannot be the sequence of edges added, in that order, to a minimum spanning tree using Kruskal's algorithm? <br><br><strong>(GATE CSE 2006)</strong></p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 8,
          "question": "<p>What is the weight of a minimum spanning tree of the following graph? <br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\Minimum_Spanning_Tree\\q68_3abc224c.jpg\"> <br><br><strong>(GATE CSE 2003)</strong></p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>29</p>",
            "<b>B.</b> <p>31</p>",
